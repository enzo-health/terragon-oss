...
> **Snapshot notice (January 16, 2026):** This repository is an open-source snapshot of Leo at the time of shutdown. It is provided **as-is**, with no guarantees of maintenance, support, or completeness.

![Leo](https://cdn.terragonlabs.com/dashboard-beRp.png)

Delegate work to coding agents in the cloud.

For trademark use, see `TRADEMARKS.md`.
For rename/cutover details and legacy alias timelines, see [docs/leo-rename-migration.md](docs/leo-rename-migration.md).
...
- **BYO Subscription & API Keys**: Use your existing Claude or ChatGPT subscriptions to power coding agents, or configure Leo with your own API keys.
...
- **Integrates with Existing Workflows**: @-mention Leo tools like Slack or GitHub to kick off tasks directly where context already exists.
