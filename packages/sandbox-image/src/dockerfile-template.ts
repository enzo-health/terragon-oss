...
# Configure Codex with increased timeouts and retries for long-running tasks
# Settings must be under [model_providers.openai] — root-level keys are silently ignored by codex_core
# Note: request_max_retries cannot be overridden for the built-in openai provider (Codex #3026)
