...
export const devDefaultRedisUrl = "http://localhost:8079";
export const devDefaultRedisToken = "redis_dev_token";
export const devDefaultIsAnthropicDownUrl = "http://localhost:5173";
export const devDefaultIsAnthropicDownApiSecret = "isanthropicdown-dev-secret";
