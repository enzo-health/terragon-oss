...
- **GitHub Mention**: these allow you to customize the behavior when @leo-labs is mentioned in pull requests, issues, or comments
...
<Tabs items={["Schedule", "GitHub Pull Request", "GitHub Issue", "GitHub Mention", "Manual"]}>
  ...
  <Tab value="GitHub Mention">
    Tasks that run when @leo-labs is mentioned in pull requests, issues, or comments:
...
<Callout type="info">
For comprehensive information about how Leo protects against prompt injection and other security threats, see our [<Lock className="inline-block w-4 h-4 mx-1" /> **Security & Permissions**](/docs/security-permissions#prompt-injection-protection) documentation.
</Callout>
