...
- **Linear Integration**: Create Terragon tasks directly from Linear by mentioning or assigning the Linear Agent. Terragon fetches the issue context, suggests a repository, and starts working in an isolated sandbox. Install the workspace agent and link your Linear account in [Settings > Integrations](https://www.terragonlabs.com/settings/integrations), then check the [Linear integration guide](/docs/integrations/linear-integration) for setup instructions.
