...
| Codex       | GPT-5.5            | `@terragon-labs [gpt-5.5] ...` OR <br /> `@terragon-labs [gpt-5.5-medium] ...`           |
| Codex       | GPT-5.5-Low        | `@terragon-labs [gpt-5.5-low] ...`                                                       |
| Codex       | GPT-5.5-High       | `@terragon-labs [gpt-5.5-high] ...`                                                      |
| Codex       | GPT-5.5-XHigh      | `@terragon-labs [gpt-5.5-xhigh] ...`                                                     |
...
| OpenCode    | Kimi K2.5          | `@terragon-labs [kimi-k2.5] ...`                                                         |
| OpenCode    | GLM 5.1            | `@terragon-labs [glm-5.1] ...`                                                           |
