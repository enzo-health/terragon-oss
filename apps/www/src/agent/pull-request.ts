...
import { getGithubPRStatus } from "@leo/shared/github-api/helpers";
import { upsertGithubPR } from "@leo/shared/model/github";
import { updateThread, getThread } from "@leo/shared/model/threads";
import {
...
export async function openPullRequestForThread({
  ...
  prBody += [
    ...
    "\n\n---\n\n",
    "ℹ️ Tag @leo-labs to ask questions and address PR feedback",
    "\n\n",
