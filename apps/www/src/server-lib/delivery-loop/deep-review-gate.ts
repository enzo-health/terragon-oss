 ...
 * 100K chars ≈ 25-30K tokens, leaving headroom for system prompt,
 * task context, and output within Codex's context window.
 */
export const MAX_GATE_DIFF_CHARS = 100_000;
