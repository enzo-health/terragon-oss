...
>(({ className, ...props }, ref) => {
  return (
    <RadioPrimitive.Root
      ref={ref}
      className={cn(
        "aspect-square h-4 w-4 rounded-full border border-hairline bg-canvas text-coral data-[checked]:border-coral data-[checked]:bg-coral transition-[color,background-color,border-color] duration-150 outline-none focus-visible:ring-2 focus-visible:ring-coral/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
